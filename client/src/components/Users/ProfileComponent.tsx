...
render(){
    ...
    return(
        ...
        <CardBody>
          <CardText>
          <h3>First Name :{this.props.auth.userinfo.givenName || this.props.auth.userinfo.firstname}</h3>
          <h3>Last Name :{this.props.auth.userinfo.familyName|| this.props.auth.userinfo.firstname}</h3>
        ...
        <Button color="info" onClick={this.togglePasswordModal}>
          ...
          <Modal isOpen={this.state.isPasswordModalOpen} toggle={this.togglePasswordModal}>
                            ...
                            <LocalForm model="passwordform" onSubmit={(values) => {
                                ...
                                <FormGroup>
                                    ...
                                    <Control.text model=".password" id="password" name="password"
                                        className="form-control" placeholder="password" validators={{
                                ...
                                <FormGroup>
                                    ...
                                    <Control.text model=".newpassword" id="newpassword" name="newpassword"
                                        className="form-control" placeholder="New Password" validators={{
                                            required, minLength: minLength(6), maxLength: maxLength(20)
                                        }} />
                                    <Errors className="text-danger" model=".newpassword" show="touched" messages={{
                                        required: 'Required',
                                        minLength: ' Must be greater than 5 characters', maxLength: ' Must be 20 characters or less'
                                    }} />
                                </FormGroup>
                                <FormGroup>
                                    ...
                                    <Control.text model=".confirm" id="confirm" name="confirm"
                                        ...
                                        placeholder="Re-enter the new password" validators={{
                                            required, minLength: minLength(6), maxLength: maxLength(20)
                                        }} />
                                    <Errors className="text-danger" model=".confirm" show="touched" messages={{
                                        required: 'Required',
                                        minLength: ' Must be greater than 5 characters', maxLength: ' Must be 20 characters or less'
                                    }} />
                                </FormGroup>
                ...
                ) : ( <div className="container mt-6 home text-center align-self-center"><p>Google user does not have this function</p></div>) 
                }
