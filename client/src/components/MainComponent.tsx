...
const mapDispatchToProps:any = (dispatch: (arg0: { (dispatch: Function): Promise<any>; (dispatch: Function): Promise<any>; (dispatch: Function): Promise<any>; (dispatch: Function): Promise<any>; (dispatch: Function): Promise<any>; (dispatch: Function): Promise<any>; (dispatch: Function): Promise<any>; (dispatch: Function): void; (dispatch: Function): Promise<void>; (dispatch: Function): Promise<any>; (dispatch: Function): Promise<any>; (dispatch: Function): Promise<any>; (dispatch: Function): Promise<any>; }) => void) => ({
...
class Main extends Component<any,any> {
  ...
  componentDidMount() {
    ...
    changeSelected(_id: any){
      this.setState({selectedBook:this.props.books.books.filter((book: { _id: any; })=>(book._id===_id))[0]});
    }
    ...
    render(){
      ...
      const UserWithId = ({match}:any) => {
        ...
        return(
          ...
          errMess={this.props.users.errMess || notFoundErr} editPassword={""} auth={undefined}/>
            );
        };
